...
include(dirname(__FILE__, 3).'/controllers/user/show_sign_up_controller.php');
...
<body>
    <div class="container">
    <?php include(dirname(__FILE__, 2).'/top_header.php')?>
        <div class="ladybug">
            <div class="balloon">
                <div class="msg">
                    <?= $show_msg ?>
        ...
        <form method="post" action="/controllers/user/sign_up_check_controller.php" class="basic">
            <!-- ワンタイムトークン発生 -->
