...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= basename(dirname(__FILE__, 2).'/public/css/color_template.css') ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?= basename('../public/css/top_header.css') ?>">
</head>
<body>
   <div class="container">
    <?php include(dirname(__FILE__).'/top_header.php')?>
        <section class="top">
            ...
            <div class="sign_nav">
                <a class="sign_in" href="<?= basename('../Views/user/sign_in.php') ?>"> 
                ...
                <a class="sign_up" href="<?= basename('../Views/user/sign_up.php') ?>">
        ...
        <section class="news">
            <img src="<?= basename('../public/img/header_news.png') ?>">
        ...
        <section class="feature">
            <img src="<?= basename('../public/img/header_feature.png') ?>">
            <h1>3 FEATURES OF 'note IT'</h1>
            <div class="feature_contents">
                <div>
                    <img src="<?= basename('../public/img/feature_sepalete.png') ?>">
                    <p>ノートからさらに<br/>チャプターへ分けて<br/>ページを保存できます。</p>
                </div>
                <div>
                    <img src="<?= basename('../public/img/feature_color.png') ?>">
                    <p>ラインナップから<br/>好きなカラーを選んで<br/>保存できます。</p>
                </div>
                <div>
                    <img src="<?= basename('../public/img/feature_type.png') ?>">
        ...
        <section class="story">
            <img src="<?= basename('../public/img/header_story.png') ?>">
            <div class="story_frame">
                ...
                <div class="second_contents">
                    <img src="<?= basename('/public/img/story_1.png') ?>">
                ...
                <div class="third_contents">
                    ...
                    <p>一文字でも失敗したと感じたら<br/>
                        ...
                        紙も時間も無駄にしていました。</p>
                    <img src="<?= basename('/public/img/story_2.png') ?>">
                </div> 
                <div class="forth_contents">
                    <div class="balloon">
                        <p>自分でクラウドノートを作れば<br/>
                            ...
                            同じような悩みを抱える人の<br/>
                            手助けになるかもしれない…</p>
                        <img src="<?= basename('/public/img/bubble_lg.png') ?>">
                    </div>
                    <img src="<?= basename('/public/img/story_3.png') ?>">
                    <p>この「ある日の思いつき」が<br/>
                        note ITは生まれました。</p>
                </div>
                <div class="fifth_contents">
                    <img src="<?= basename('/public/img/story_4.png') ?>">
                ...
                <a class="note blue lets_signin" href="<?= basename('/Views/user/sign_up.php') ?>">
                    <div class="note_base"></div>
                    <div class="note_title">
                        <p>Let's<br/>
                        Sign Up!!</p>
    ...
    <script src="<?= basename('/public/js/inclusion.js') ?>" type="text/javascript"></script>
    <script src="<?= basename('/public/js/top.js') ?>" type="text/javascript"></script>
</body>
</html>