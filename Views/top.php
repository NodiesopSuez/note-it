...
<head>
    ...
    <link rel="stylesheet" type="text/css" href=".<?= dirname(__FILE__, 4).'/public/css/template.css' ?>">
    <link rel="stylesheet" type="text/css" href=".<?= dirname(__FILE__, 4).'/public/css/color_template.css' ?>">
    <link rel="stylesheet" type="text/css" href=".<?= dirname(__FILE__, 4).'/public/css/top_wide.css' ?>" media="screen and (min-width:1024px)">
    <link rel="stylesheet" type="text/css" href=".<?= dirname(__FILE__, 4).'/public/css/top_narrow.css' ?>" media="screen and (max-width:1023px)">
    <link rel="stylesheet" type="text/css" href=".<?= dirname(__FILE__, 4).'/public/css/template.css' ?>">
    <link rel="stylesheet" type="text/css" href=".<?= dirname(__FILE__, 4).'/public/css/top_header.css' ?>">
</head>
<body>
   <div class="container">
